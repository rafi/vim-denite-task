...
_ts = time.time()
UTC_OFFSET = (datetime.datetime.fromtimestamp(_ts) -
              datetime.datetime.utcfromtimestamp(_ts)).total_seconds()
...
class SerializingObject(object):
    ...
    def timestamp_serializer(self, date):
        ...
        date = datetime.datetime.utcfromtimestamp(
            time.mktime(date.timetuple())).replace(tzinfo=local_zone)
    ...
    def timestamp_deserializer(self, date_str):
        ...
        naive_timestamp += datetime.timedelta(seconds=UTC_OFFSET)
        return naive_timestamp.replace(tzinfo=local_zone)
